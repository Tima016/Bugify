...
export declare class ReportsService {
    ...
    findByResearcher(researcherId: string): Promise<({
        program: {
            company: {
                companyName: string;
                logoUrl: string | null;
    ...
    updateStatus(id: string, userId: string, updateStatusDto: UpdateReportStatusDto): Promise<{
        researcher: {
            id: string;
            email: string;
            username: string;
    ...
    getStatsByProgram(programId: string): Promise<{
        totalReports: number;
